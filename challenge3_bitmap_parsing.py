...
file_population_density = "population-density-map.bmp"
file_elevation_mer_blue = "elevation1x1_new-mer-bleue.bmp"

img_file_population_density = open(file_population_density, 'rb')  # open a binary file
img_elevation_mer_blue = open(file_elevation_mer_blue, 'rb')  # open a binary file
images = [img_file_population_density, img_elevation_mer_blue]
